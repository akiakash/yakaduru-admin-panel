    ...
    menuItems: [
      {
        ...
        route: "#",
        children: [
          { label: "Add Safari", route: "/safari/AddSafari" },
          { label: "Manage Safari Packages", route: "/safari/SafariList" },
          { label: "Bookings", route: "/" },
        ],
      },
      {
      ...
      },
      {
        ...
        route: "#",
        children: [
          { label: "Allocate Slots", route: "/slots/AllocateSlots" },
          { label: "Manage Slots", route: "/slots/ManageSlots" },
        ],
      },
      {
        label: "BLOGS",
        route: "#",
        children: [
          { label: "Add Blogs", route: "/blogs/AddBlogs" },
          { label: "Manage Blogs", route: "/blogs/ManageBlogs" },
          { label: "Manage Category ", route: "/blogs/ManageCategory" },
